...
public class RedBlackTree<T extends Comparable<T>> implements SortedCollectionInterface<T> {
    ...
    private void rotate(Node<T> child, Node<T> parent) throws IllegalArgumentException {
        ...
        if (parent.leftChild == child) {
            ...
            throw new IllegalArgumentException("Parent Child/ NO MATCH");
    }
    ...
    /**
     * Enforce RedBlackTree properties after a new node is inserted into the tree
     *
    ...
    public void enforceRBTreePropertiesAfterInsert(Node<T> newNode) {
        ...
        if (newNode.parent != null) {
            if (!newNode.parent.equals(root)) {
                Node<T> tempNode = null;
                if (newNode.parent.isLeftChild()) {
                    tempNode = newNode.parent.parent.rightChild;
                } else {
                    tempNode = newNode.parent.parent.leftChild;
                }
                    ...
                    if (!newNode.parent.isLeftChild()) {
                        if ((tempNode == null || tempNode.isBlack)) {
                            if (!newNode.parent.isBlack) {
                                boolean changeColors = newNode.parent.isBlack;

                                newNode.parent.isBlack = newNode.parent.parent.isBlack;
                                newNode.parent.parent.isBlack = changeColors;
                ...
                if (tempNode != null) {
                    if (!newNode.parent.isBlack) {
                        if (!tempNode.isBlack) {
                            ...
                            newNode.parent.isBlack = newNode.parent.parent.isBlack;
                            tempNode.isBlack = newNode.parent.parent.isBlack;
                            newNode.parent.parent.isBlack = changeColors;
